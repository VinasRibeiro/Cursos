...
*** comment ***
Set Test Variable faz com que a variável produtp esteja disponivel 
para toda a execução dos casos de teste.
no caso ${produto} esta disponível para todos os testes