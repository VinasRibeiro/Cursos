...
#Este comentário serve para avisar o cucumber que a linguagem natural usada aqui é o portugues.
...
#O esquema do Cenario é um grupo de dados que utilizam o mesmo comportamento.
...
#Aqui esta só o código dos dados que estão no arquivo movies.yaml
        Exemplos:
            | codigo     |
            | "ultimato" |
            | "spider"   |
